  ...
  return (
    <>
      ...
      >
        ...
        {/* 🔥 BUTTON WITH PULSE */}
        <div className="relative bg-green-500 w-14 h-14 flex items-center justify-center rounded-full shadow-lg hover:scale-110 active:scale-95 transition duration-300 animate-[pulse_2s_infinite]">
        ...
        {/* TOOLTIP */}
        <div className="absolute right-16 bottom-2 bg-black text-white text-xs px-3 py-1 rounded opacity-0 group-hover:opacity-100 transition">
          Chat with us
        </div>
      ...
      {/* 🔥 POPUP MESSAGE */}
      {showMessage && (
        <div className="fixed bottom-20 right-5 bg-white text-black px-5 py-3 rounded-xl shadow-xl z-50 text-sm border">
          ...
          <p className="text-xs text-gray-600 mt-1">
            We’ll enable WhatsApp booking shortly.
          </p>
